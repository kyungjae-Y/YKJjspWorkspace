					...
					<table class="upload-table">
						<tr>
							<td rowspan="9" class="img-td">
								<img name="img" id="inputImg" src="https://upload.wikimedia.org/wikipedia/commons/1/14/No_Image_Available.jpg" />
							</td>
						</tr>
						<tr>
							<td>차량이름</td>
							<td>
								<input class="fv" type="text" name="name" value="test" />
							</td>
						</tr>
						<tr>
							<td>차량분류</td>
							<td class="radio-td">
								<input type="radio" name="category" value="1" class="fv" checked />
								소형 &nbsp;
						...
						<tr>
							<td>렌트 가격</td>
							<td>
								<input class="fv" type="number" name="price" value="1000" />
							</td>
						</tr>
						<tr>
							<td>승차 인원</td>
							<td>
								<input class="fv" type="number" name="usepoeple" value="4" />
							</td>
						</tr>
						<tr>
							<td>재고 수량</td>
							<td>
								<input class="fv" type="number" name="totalQty" value="3" />
							</td>
						</tr>
						<tr>
							<td>제조 회사</td>
							<td>
								<input class="fv" type="text" name="company" value="기아" />
							</td>
						</tr>
						<tr>
							<td>차랑 정보</td>
						...
						<tr height="40">
							...
							<td colspan="2">
								<input type="button" class="upload-btn" value="차량 등록" onclick="insertCar()" />
							</td>
						</tr>
					</table>
				</div>
