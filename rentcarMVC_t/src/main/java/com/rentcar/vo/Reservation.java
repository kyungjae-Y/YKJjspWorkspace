...
public class Reservation {
	...
	public String toString() {
		return "Reservation [reserveSeq=" + reserveSeq + ", num=" + num + ", userid=" + userid + ", qty=" + qty + ", dday=" + dday + ", rday=" + rday + ", usein=" + usein + ", usewifi=" + usewifi + ", usenavi=" + usenavi + ", useseat=" + useseat + "]";
	}
