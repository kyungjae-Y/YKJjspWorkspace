...
<body>
	...
	<div align="center">
		...
		<form action="01_carMain.jsp?center=11_carOptionSelect.jsp" method="post">

			<table>
				<tr height="100">
					<td align="center" colspan="3">
						<font size="6" color="gray"> <%=bean.getName()%> 차량 선택
						</font>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width="250" align="center"><%=bean.getPrice()%>원
					</td>
				</tr>
				<tr>
