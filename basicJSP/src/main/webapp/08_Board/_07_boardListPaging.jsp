...
<body>
	...
	%>
	[
	<a href="_07_boardListPaging.jsp?start=<%=한페이지에보여줄페이지시작번호 - 1%>&curNum=<%=한페이지에보여줄페이지시작번호 - 한페이지에보여줄페이지번호개수%>"> 이전 </a>]
	<%
	}
	%>
	<%
	...
	[
	<a href="_07_boardListPaging.jsp?start=<%=i%>&curNum=<%=한페이지에보여줄페이지시작번호%>"> <%=i%>
	</a>]
	...
	%>
	[
	<a href="_07_boardListPaging.jsp?start=<%=한페이지에보여줄페이지시작번호 + 한페이지에보여줄페이지번호개수%>&curNum=<%=한페이지에보여줄페이지시작번호 + 한페이지에보여줄페이지번호개수%>"> 이후 </a>]
	<%
	}
	%>
	<br>
