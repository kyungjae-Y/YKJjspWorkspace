...
<body>
	...
	<h1>
		<%=pw%></h1>
	<h1>
		<%=Arrays.toString(member)%></h1>

	<h1>로그인</h1>
	<form method="post" action="loginPro.jsp">
		ID : <input type="text" name="inputId" /> <br>
		<br> PW : <input type="text" name="inputPw" /> <br>
		<br> <input type="hidden" name="name" value="<%=name%>" /> <input type="hidden" name="id" value="<%=id%>" /> <input type="hidden" name="pw" value="<%=pw%>" /> <input type="submit" value="LOG-IN" />
	</form>
	<br>
