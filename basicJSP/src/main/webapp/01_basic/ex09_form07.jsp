...
<body>
	<div align="center">
		...
		<form method="post" action="ex10_form07pro.jsp">
			<table border="1">
				<tr>
					<td>학번</td>
				...
				<tr>
					<td>학년</td>
					<td><input type="radio" name="grade" value="1" <%if(grade == 1){%> checked <%}%>>1학년&nbsp;
						<input type="radio" name="grade" value="2" <%if(grade == 2){%> checked <%}%>>2학년&nbsp; 
						<input type="radio" name="grade" value="3" <%if(grade == 3){%> checked <%}%>>3학년&nbsp; 
						<input type="radio" name="grade" value="4" <%if(grade == 4){%> checked <%}%>>4학년</td>
				</tr>
				<tr>
					<td>선택과목</td>
				...
				<tr>
					...
					<td><input type="checkbox" name="hobbies" value="운동">운동
						...
						<input type="checkbox" name="hobbies" value="쇼핑">쇼핑</td>
				</tr>
				<tr>
					<td>메모</td>
